...
The keys live in `.codex/settings.json` (project) or `/Users/kunalkhande/Downloads/AyushKh/Ryze Techonology/Website /Ryze-Techonology-v1/.codex/settings.json` (global) — **not** in `.planning/config.json`:
