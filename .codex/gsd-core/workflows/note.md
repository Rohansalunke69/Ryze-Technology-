...
- **Global scope**: `/Users/kunalkhande/Downloads/AyushKh/Ryze Techonology/Website /Ryze-Techonology-v1/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/kunalkhande/Downloads/AyushKh/Ryze Techonology/Website /Ryze-Techonology-v1/.codex/notes/`)
...
2. Glob `/Users/kunalkhande/Downloads/AyushKh/Ryze Techonology/Website /Ryze-Techonology-v1/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/kunalkhande/Downloads/AyushKh/Ryze Techonology/Website /Ryze-Techonology-v1/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/kunalkhande/Downloads/AyushKh/Ryze Techonology/Website /Ryze-Techonology-v1/.codex/notes/` — works in any directory
